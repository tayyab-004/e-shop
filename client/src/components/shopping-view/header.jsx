...
function MenuItems() {
  ...
  function handleNavigate(getCurrentMenuItem) {
    ...
    location.pathname.includes("listing") && currentFilter !== null
      ...
      : navigation(getCurrentMenuItem.path);
  }
...
function HeaderRightContent() {
  ...
  return (
    <div className="flex lg:flex-center lg:flex-row flex-col gap-4">
      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent side="right" className="w-56">
          <DropdownMenuLabel>Sign in as {user?.userName}</DropdownMenuLabel>
          <DropdownMenuSeparator />
